...
public class CircularCheckbox extends View implements Checkable{
    ...
    public CircularCheckbox(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        checkDrawable = context.getResources().getDrawable(R.drawable.client_circular);//选中时对钩样式
