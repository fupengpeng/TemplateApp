...
public class WheelView extends ScrollView {
    ...
    public static class OnWheelViewListener {
        public void onSelected(int selectedIndex, String item) {
            LogUtils.e("OnWheelViewListener . onSelected");
        }
    }
...
//        Log.d(TAG, "scrollview: " + scrollView);
        ...
        LogUtils.e("parent: " + this.getParent());
...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
                    if (remainder == 0) {
                        ...
                        LogUtils.e("selectedIndex 00 = " + selectedIndex);
                        onSeletedCallBack();
                    } else {
                        if (remainder > itemHeight / 2) {
                            WheelView.this.post(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    LogUtils.e("selectedIndex  2 = " + selectedIndex);
                                    onSeletedCallBack();
                                }
                            });
                        } else {
    ...
    public void startScrollerTask() {
        LogUtils.e("startScrollerTask = " + getScrollY());
        initialY = getScrollY();
    ...
    private void initData() {
        ...
        LogUtils.e("initData = " + displayItemCount );
...
//            position = divided + offset + 1;
    ...
    private int[] obtainSelectedAreaBorder() {
        ...
        LogUtils.e("obtainSelectedAreaBorder = " + selectedAreaBorder);
    ...
    private void onSeletedCallBack() {
        if (null != onWheelViewListener) {
            LogUtils.e("onSeletedCallBack:   selectedIndex =  " + selectedIndex );
